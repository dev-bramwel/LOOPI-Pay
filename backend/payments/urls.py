...
urlpatterns = [
    ...
    path('admin/webhook-audits/<int:pk>/', views.webhook_audit_detail, name='webhook_audit_detail'),
    path('admin/webhook-audits/<int:pk>/reprocess/', views.webhook_audit_reprocess, name='webhook_audit_reprocess'),
]
